...
> **Template.** Copy to `docs/ai/db/FUNCTIONS-TRIGGERS-GUIDE.md` and fill with real content. Delete this banner.
...
<!-- Checks, uniques, exclusion constraints (e.g. scheduling overlap prevention) and their business meaning. -->
